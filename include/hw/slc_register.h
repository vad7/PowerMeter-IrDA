/*
 * ESP8266 SLC registers
 */
	
#ifndef SLC_REGISTER_H_
#define SLC_REGISTER_H_

#define REG_SLC_BASE_ADDRESS  0x60000B00
//version value:32'h091700

#define SLC_CONF0_ADDRESS						(REG_SLC_BASE_ADDRESS + 0x0)
#ifndef ESP_MAC_5
...
#define SLC_INT_RAW_ADDRESS						(REG_SLC_BASE_ADDRESS + 0x4)
...
#define SLC_INT_STATUS_ADDRESS					(REG_SLC_BASE_ADDRESS + 0x8)
...
#define SLC_INT_ENA_ADDRESS					(REG_SLC_BASE_ADDRESS + 0xC)
...
#define SLC_INT_CLR_ADDRESS					(REG_SLC_BASE_ADDRESS + 0x10)
...
#define SLC_TX_LINK_ADDRESS							 (REG_SLC_BASE_ADDRESS + 0x28)
...
#define SLC_INTVEC_TOHOST_ADDRESS						(REG_SLC_BASE_ADDRESS + 0x2C)
#define SLC_TOHOST_INTVEC 0x000000FF
#define SLC_TOHOST_INTVEC_S 0

#define SLC_TOKEN0_ADDRESS							(REG_SLC_BASE_ADDRESS + 0x30)
...
#define SLC_TOKEN1_ADDRESS							(REG_SLC_BASE_ADDRESS + 0x34)
...
#define SLC_CONF1_ADDRESS								(REG_SLC_BASE_ADDRESS + 0x38)
#define SLC_STATE0_ADDRESS							(REG_SLC_BASE_ADDRESS + 0x3C)
#define SLC_STATE1_ADDRESS							(REG_SLC_BASE_ADDRESS + 0x40)

#define SLC_BRIDGE_CONF_ADDRESS						 (REG_SLC_BASE_ADDRESS + 0x44)
#ifndef ESP_MAC_5
...
#define SLC_RX_EOF_DES_ADDR_ADDRESS					(REG_SLC_BASE_ADDRESS + 0x48)
#define SLC_TX_EOF_DES_ADDR_ADDRESS					(REG_SLC_BASE_ADDRESS + 0x4C)
#define SLC_FROM_HOST_LAST_DESC				SLC_TX_EOF_DES_ADDR
#define SLC_TO_HOST_LAST_DESC					SLC_RX_EOF_DES_ADDR

#define SLC_RX_EOF_BFR_DES_ADDR_ADDRESS				(REG_SLC_BASE_ADDRESS + 0x50)
#define SLC_AHB_TEST_ADDRESS							(REG_SLC_BASE_ADDRESS + 0x54)
...
#define SLC_SDIO_ST_ADDRESS							(REG_SLC_BASE_ADDRESS + 0x58)
...
#define SLC_RX_DSCR_CONF_ADDRESS						(REG_SLC_BASE_ADDRESS + 0x5C)
#ifdef ESP_MAC_5
...
#define SLC_TXLINK_DSCR_ADDRESS						(REG_SLC_BASE_ADDRESS + 0x60)
#define SLC_TXLINK_DSCR_BF0_ADDRESS					(REG_SLC_BASE_ADDRESS + 0x64)
#define SLC_TXLINK_DSCR_BF1_ADDRESS					(REG_SLC_BASE_ADDRESS + 0x68)
#define SLC_RXLINK_DSCR_ADDRESS						(REG_SLC_BASE_ADDRESS + 0x6C)
#define SLC_RXLINK_DSCR_BF0_ADDRESS					(REG_SLC_BASE_ADDRESS + 0x70)
#define SLC_RXLINK_DSCR_BF1_ADDRESS					(REG_SLC_BASE_ADDRESS + 0x74)
#define SLC_DATE_ADDRESS								(REG_SLC_BASE_ADDRESS + 0x78)
#define SLC_ID_ADDRESS								(REG_SLC_BASE_ADDRESS + 0x7C)

#define SLC_HOST_CONF_W0_ADDRESS						(REG_SLC_BASE_ADDRESS + 0x80 + 0x14)
#define SLC_HOST_CONF_W1_ADDRESS						(REG_SLC_BASE_ADDRESS + 0x80 + 0x18)
#define SLC_HOST_CONF_W2_ADDRESS						(REG_SLC_BASE_ADDRESS + 0x80 + 0x20)
#define SLC_HOST_CONF_W3_ADDRESS						(REG_SLC_BASE_ADDRESS + 0x80 + 0x24)
#define SLC_HOST_CONF_W4_ADDRESS						(REG_SLC_BASE_ADDRESS + 0x80 + 0x28)

#define SLC_HOST_INTR_ST_ADDRESS						(REG_SLC_BASE_ADDRESS + 0x80 + 0x1c)
#define SLC_HOST_INTR_CLR_ADDRESS						(REG_SLC_BASE_ADDRESS + 0x80 + 0x30)
#define SLC_HOST_INTR_SOF_BIT					(BIT(12))

#define SLC_HOST_INTR_ENA_ADDRESS						(REG_SLC_BASE_ADDRESS + 0x80 + 0x34)
#define SLC_RX_NEW_PACKET_INT_ENA 		(BIT23)
#define SLC_HOST_TOHOST_BIT0_INT_ENA		(BIT0)
#define SLC_HOST_CONF_W5_ADDRESS						 (REG_SLC_BASE_ADDRESS + 0x80 + 0x3C)
#define SLC_HOST_INTR_RAW_ADDRESS						(REG_SLC_BASE_ADDRESS + 0x80 + 0x8)
...
#define SLC_TX_DESC_DEBUG_REG_ADDRESS  0x3ff0002c  //[15:0] set to 0xcccc
