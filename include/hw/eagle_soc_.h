...
#define	GPIO_IN_ADDRESS				0x18  // +PERIPHS_GPIO_BASEADDR, GPIO at startup/RESET, bits: 16..31
...
#define FRC_CTRL_ENABLE_TIMER		(BIT(7))
#define FRC_CTRL_AUTO_RELOAD_CNT	(BIT(6))
#define FRC_CTRL_PRESCALE			0x00000003 // bit[3:2]: 0: divided by 1, 1: divided by 16, 2 or 3: divided by 256
#define FRC_CTRL_PRESCALE_S		2
#define FRC_CTRL_INT_TYPE			(BIT(0)) // bit[0]: interrupt type, 0:edge, 1:level
//clear	timer1's	interrupt	when	write	this	address
#define	FRC1_INT_ADDRESS			0x0c
#define	FRC1_INT_CLR_MASK			(BIT(0))

#define	FRC2_LOAD_ADDRESS			0x20
//timer2's	counter	value(count	from	initial_value	to	0)
#define	FRC2_COUNT_ADDRESS			0x24
#define	FRC2_CTRL_ADDRESS			0x28
#define	FRC2_INT_CLR_MASK			(BIT(0))
#define	FRC2_INT_ADDRESS			0x2C
...
#define	PIN_FUNC_SELECT(PIN_NAME, FUNC)	WRITE_PERI_REG(PIN_NAME, (READ_PERI_REG(PIN_NAME) & (~(PERIPHS_IO_MUX_FUNC<<PERIPHS_IO_MUX_FUNC_S))) | ((((FUNC&BIT2)<<2)|(FUNC&0x3))<<PERIPHS_IO_MUX_FUNC_S))
