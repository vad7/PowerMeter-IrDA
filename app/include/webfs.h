...
void WEBFSInit(void) ICACHE_FLASH_ATTR;
WEBFS_HANDLE WEBFSOpen(uint8* cFile) ICACHE_FLASH_ATTR;
void WEBFSClose(WEBFS_HANDLE hWEBFS) ICACHE_FLASH_ATTR;

uint16 WEBFSGetArray(WEBFS_HANDLE hWEBFS, uint8* cData, uint16 wLen) ICACHE_FLASH_ATTR;

uint16 WEBFSGetFlags(WEBFS_HANDLE hWEBFS) ICACHE_FLASH_ATTR;
uint32 WEBFSGetSize(WEBFS_HANDLE hWEBFS) ICACHE_FLASH_ATTR;
uint32 WEBFSGetBytesRem(WEBFS_HANDLE hWEBFS) ICACHE_FLASH_ATTR;
WEBFS_PTR WEBFSGetStartAddr(WEBFS_HANDLE hWEBFS) ICACHE_FLASH_ATTR;
WEBFS_PTR WEBFSGetEndAddr(WEBFS_HANDLE hWEBFS) ICACHE_FLASH_ATTR;
