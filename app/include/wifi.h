...
// default:
...
#endif
#ifndef PHY_MODE
	#define PHY_MODE PHY_MODE_11G // PHY_MODE_11N // PHY_MODE_11G // PHY_MODE_11B
#endif
	...
	#define DEF_WIFI_AUTH_MODE AUTH_WPA2_PSK // AUTH_OPEN // AUTH_WPA_PSK, AUTH_WPA2_PSK, AUTH_WPA_WPA2_PSK
#endif

#ifndef DEF_ST_RECONNECT_TIME
	#define DEF_ST_RECONNECT_TIME 60 // следующая проба соединения ST произойдет через reconn_timeout секунд. При DEF_ST_RECONNECT_TIME == 1 данный алго отключен.
#endif

#define MAX_PHY_TPW 82 // maximum value of RF Tx Power, unit : 0.25dBm, range 0..82
#define DEF_MAX_PHY_TPW 74 //82 // maximum value of RF Tx Power, unit : 0.25dBm, range 0..82
